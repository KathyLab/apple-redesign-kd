...
const Product = ({ product }: Props) => {
  // shoot actions with this dispatch
  ...
  return (
    <div className="md:p-10F flex h-fit w-[320px] select-none flex-col space-y-3 rounded-xl bg-[#35383C] p-8 md:h-[500px] md:w-[400px]">
